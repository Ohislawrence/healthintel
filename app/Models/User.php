...
#[Fillable(['name', 'email', 'phone', 'password', 'google_id', 'email_verification_code', 'email_verification_code_expires_at', 'email_verified_at', 'phone_verified_at', 'referral_code', 'referred_by_user_id', 'bank_name', 'account_number', 'account_name'])]
