...
@section('description', 'Affordable credit-based pricing for lab result interpretation. Get free credits on signup. Pay only when you need to interpret a lab report.')
...
<section class="section">
    <div class="wrap">
        <div class="section-header center">
            ...
            <p class="anim-fade-up d2">Get free credits when you sign up. Buy more as needed — no subscriptions.</p>
        </div>
        ...
        <div class="text-center anim-fade-up d2" style="color:var(--text-muted);font-size:0.9rem">
            <p>Credits never expire. No monthly fees.</p>
        </div>
    </div>
</section>
@endsection